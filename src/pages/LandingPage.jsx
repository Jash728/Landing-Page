...
const LandingPage = () => {
  ...
  const handleFormSubmit = (e) => {
    e.preventDefault();
    alert(
      `Thank you, ${formData.name}! We'll contact you at ${formData.phone} about your interest in ${formData.profession}.`
    );
    setFormData({
      name: "",
      phone: "",
  ...
  return (
    <div className="min-h-screen bg-[#FFFDF5] font-sans">
      ...
      <Modal isOpen={isModalOpen} onClose={handleModalClose} setIsModalOpen = {setIsModalOpen}>
        ...
        <form onSubmit={handleFormSubmit}>
          ...
          <button
            type="submit"
            className="w-full bg-[#EB7A52] text-white py-3 rounded-lg hover:bg-[#2127F6] transition-all"
          >
            Submit
          </button>
        </form>
